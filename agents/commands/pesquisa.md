...
Durante a implementação do plano, deve-se sempre utilizar "subagents".

Seja extremamente detalhista, técnico e prático.

---

## Compatibilidade com Super Mode

Se o Super Mode estiver ativo, este comando funciona como **modo de pesquisa dentro dele** — mantendo todas as regras do Super Mode ativas (auto-verificação, prefixo, checklist de conformidade).

**Quando ativo simultaneamente:**
- O prefixo `[🔵 Super Mode Ativo — OpenCode CLI]` deve aparecer em todas as respostas
- A auto-verificação continua obrigatória
- O plano gerado segue a estrutura de 10 seções deste comando
- A implementação (se autorizada) usa subagents conforme o Super Mode
- Após concluir, pergunte: **"Deseja designar uma nova tarefa ou desativar o Super Mode?"**
